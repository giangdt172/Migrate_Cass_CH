...
@click.command()
# @click.option('-i', '--input-db', required=True, help='Input database')
# @click.option('-o', '--output-db', required=True, help='Output database')
...
def export_blocks_to_clickhouse(db_prefix, start_block, end_block, batch_size, max_workers, chain_id):
